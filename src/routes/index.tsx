    ...
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-6">
        ...
        <Monitor
          title="CONCENTRATION"
          action={
            <Tip content="Peso del holding más grande sobre el net worth. >30% se marca en rojo (riesgo de concentración).">
              <span className="font-mono text-[9px] text-subtle">?</span>
            </Tip>
          }
        >
      ...
      <div className="grid gap-2 lg:grid-cols-3">
        <Monitor
          title="ALLOCATION"
          action={
            <Tip content="Distribución del patrimonio por asset class. Hover sobre el donut o cada fila para detalle.">
              <span className="font-mono text-[9px] text-subtle">?</span>
            </Tip>
          }
        >
                    ...
                    content={
                      <div className="space-y-0.5">
                        ...
                        <p className="text-subtle">
                          {pct.toFixed(2)}% del patrimonio · peso relativo
                        </p>
                      </div>
                    }
                  >
            ...
            <tbody>
              {holdingsPager.slice.map((h, i) => (
                <tr
                  ...
                  title={`${h.name}${h.ticker ? ` (${h.ticker})` : ""} · ${h.type} | Valor ${formatUsd(h.valueUsd)} | P&L ${formatUsd(h.pnlUsd)} (${formatPct(h.pnlPct)}) | Peso ${h.weight.toFixed(2)}%`}
                >
      ...
      <div className="grid gap-2 lg:grid-cols-3">
        ...
        <Monitor
          ...
          action={
            <Tip content="Barras apiladas por tipo de ingreso (cupón, alquiler, dividendo, amortización). Hover para montos.">
              <span className="font-mono text-[9px] text-subtle">?</span>
            </Tip>
          }
        >
